		...
		<div class="search">
			<form action="http://localhost:8085/search.html?keyword=" id="searchForm"
				...
				<input type="text" class="text keyword ac_input" name="keyword"
					...
					autocomplete="off"> <input type="button" value="搜&emsp;索"
					class="submit button button-glow button-rounded button-caution"
					style="background-color: #dd00a7;width:80px;font:bold 18px Microsoft Yahei;border-radius:0%;text-align:center;padding:0px;" onclick="search_keys('searchForm')">
			</form>
