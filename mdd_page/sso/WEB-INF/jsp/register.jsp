...
<body>
		...
		<div class="header" style="padding-top:20px;">
			<a href="http://www.www.mdd.com"><img src="/images/logo_white.jpg" style="width:195px;height:75px;" border="0" /><span style="font-size:25px;margin-left:20px;">欢迎注册</span></a>
		</div>
...
<!-- reg_main -->
<div class="tabBox clear" style="text-align:center;height:30px;">
    <%-- <span class="reg_hide reg_show regMr5" id="regper" style="color:#999">个人用户</span> --%>
</div>
<!--个人用户-->
<div class="reg_main reg_border regTab" id="perDiv">
    <ul class="individualUserBg" style="margin:0 0px 0 250px;;;width:700px;">
        <form id="regForm_mod" name="regForm_mod" method="post"  >
            ...
            <li class="regMb30">
                <label><font>*</font> 注册邮箱：</label>
            <span class="regM defaultBorder">
              <input id="email" name="email" autocomplete="off" class="regInput" type="text" maxlength="20" onfocus="showtip('email','emailErr',1);" onblur="$('#emailErr').html('')"/>
              <em></em>
            </span>
                <span class="regInput" id="phoneErr"></span>
            </li>
			...
			<span  class="regM" style="margin-left:29px">
				...
				<a href="https://passport.www.mdd.com/xy.html" target="_blank"  class="checkTitle">我已阅读并同意<font style="font-size:12px;">《买多多商城用户注册协议》</font></a>
			</span>
    ...
    <div class="ui-reg-tip"><a href="http://help.www.mdd.com/140/6788.html" target="_blank"><span class="glyphicon glyphicon-volume-down"></span>了解更多>></a></div>
</div>
...
<!--mainOver-->
		...
		<div class="footer">
			<span>
				<a href="http://www.www.mdd.com/www/379/5109.html" rel="nofollow" class="footerlink1">关于我们</a> |
				<a href="http://www.www.mdd.com/www/380/5116.html" rel="nofollow" class="footerlink1">联系我们</a> |
				<a href="http://www.www.mdd.com/www/381/5117.html" rel="nofollow" class="footerlink1">招聘人才</a> |
				<a href="http://www.www.mdd.com/www/330/2705.html" rel="nofollow" class="footerlink1">友情链接</a> |
				<a href="http://supplier.www.mdd.com/supplierApply" rel="nofollow" class="footerlink1">供应商申请</a>
			</span>
			<p>
				北京买多多电子商务有限公司<br />
				北京市公安局顺义分局备案11011302000890号|<a href="http://www.miibeian.gov.cn" target="_blank" rel="nofollow" class="footerlink1">京ICP备12011349号</a>|<a href="http://www.www.mdd.com/www/174/461.html" target="_blank" rel="nofollow" class="footerlink1">企业营业执照</a><br />
				Copyright© 买多多商城 www.mdd.com 版权所有<br />
			</p>
		</div>
		<!-- /footer -->
<script type="text/javascript">
	var REGISTER={
		...
		beforeSubmit:function() {
				//检查用户是否已经被占用
				$.ajax({
	            	url : REGISTER.param.surl + "/user/check/1?param="+$("#regName").val()+"&r=" + Math.random(),
	            	success : function(data) {
	            		if (data.data) {
	            			//检查手机号是否存在
	            			$.ajax({
	            				url : REGISTER.param.surl + "/user/check/2?param="+$("#phone").val()+"&r=" + Math.random(),
				            	success : function(data) {
				            		if (data.data) {
					            		REGISTER.doSubmit();
				            		} else {
		...
		doSubmit:function() {
			$.post("/user/register",$("#regForm_mod").serialize(), function(data){
				if(data.status == 200){
					jAlert('用户注册成功，请去邮箱激活！',"提示", function(){
						REGISTER.login();
					});
				} else {
					jAlert("注册失败！","提示");
